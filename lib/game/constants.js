...
export const RESOURCES = {
  trust: { label: 'Public Trust', color: '#fdd835', symbol: '✟', id: 'public_trust' },
  clout: { label: 'Street Clout', color: '#ef5350', symbol: '👥', id: 'street_clout' },
  media: { label: 'Media Attention', color: '#2196f3', symbol: '📺', id: 'media_attention' },
  funds: { label: 'Campaign Funds', color: '#6ab04c', symbol: '💰', id: 'campaign_funds' },
}

export const RESOURCE_CAP = 12
export const PUBLIC_RESOURCE_START = 30
