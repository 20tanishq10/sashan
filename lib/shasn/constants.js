...
export const RESOURCES = {
  funds: { id: 'funds', label: 'Campaign Funds', ideologue: 'capitalist', color: '#0f7a4a', ink: '#ffffff' },
  clout: { id: 'clout', label: 'Street Clout', ideologue: 'supremo', color: '#a81c22', ink: '#ffffff' },
  media: { id: 'media', label: 'Media Attention', ideologue: 'showstopper', color: '#173f86', ink: '#ffffff' },
  trust: { id: 'trust', label: 'Public Trust', ideologue: 'idealist', color: '#eab134', ink: '#2a1f05' },
}
