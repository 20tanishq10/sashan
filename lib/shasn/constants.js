...
export const RESOURCES = {
  funds: { id: 'funds', label: 'Campaign Funds', ideologue: 'capitalist', color: '#6ab04c' },
  clout: { id: 'clout', label: 'Street Clout', ideologue: 'supremo', color: '#ef5350' },
  media: { id: 'media', label: 'Media Attention', ideologue: 'showstopper', color: '#2196f3' },
  trust: { id: 'trust', label: 'Public Trust', ideologue: 'idealist', color: '#fdd835' },
}
