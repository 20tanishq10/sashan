...
//
// VOLATILE INDICES are now measured too, not guessed. boardGeometry.js fits a
// hex lattice inside each traced zone outline until exactly the printed number of
// voter areas fits, and each Volatile index is the lattice point nearest a ring
// measured on the scan. An earlier note here claimed the scan was cropped at the
// right edge — it is not. East reaches x=853 in an 864px image; what looked like
// clipping was a UI overlay sitting on top of the board.
