...
export function applyEffect(effect, ctx) {
  ...
  switch (effect.type) {
    ...
    case 'cashOutVoterCards':
      // These need a sequenced, multi-player flow of their own — everyone takes
      // a turn, or a card changes hands mid-turn. Left to the table until that
      // flow exists, rather than half-applied.
      return { manual: true }
