...
const S = {
  ...
  idle: { fontSize: 11, color: 'var(--ink-on-dark-3)', lineHeight: 1.55, margin: 0, fontStyle: 'italic' },
  ...
  eyebrow: { fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.8, color: 'var(--ink-on-dark-2)', fontWeight: 700 },
  min: { fontSize: 10, color: 'var(--ink-on-dark-3)' },
  seller: { fontSize: 11, color: 'var(--ink-on-dark-2)', margin: '5px 0 0' },
  leading: { fontSize: 12, margin: '6px 0 0' },
  hint: { fontSize: 10.5, color: 'var(--ink-on-dark-3)', margin: '6px 0 0', fontStyle: 'italic' },
