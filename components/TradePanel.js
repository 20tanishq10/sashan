...
const S = {
  ...
  h4: { fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.8, color: 'var(--ink-on-dark-2)', margin: '0 0 8px' },
  hint: { fontSize: 11, color: 'var(--ink-on-dark-3)', fontStyle: 'italic' },
  ...
  termLabel: { fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.6, color: 'var(--ink-on-dark-3)', minWidth: 62 },
  chip: { padding: '2px 8px', borderRadius: 10, fontSize: 10.5, color: 'var(--surface)', whiteSpace: 'nowrap' },

  cardPick: { marginTop: 9 },
  pickLabel: { fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.6, color: 'var(--ink-on-dark-3)', display: 'block', marginBottom: 4 },
  ...
  playing: { fontStyle: 'normal', fontSize: 9, color: 'var(--ink-on-dark-3)' },
  ...
  sideLabel: { fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.7, color: 'var(--ink-on-dark-2)', marginBottom: 3 },
  swap: { alignSelf: 'center', fontSize: 18, color: 'var(--ink-on-dark-3)' },
  ...
  have: { fontSize: 9.5, color: 'var(--ink-on-dark-3)' },
  rule: { fontSize: 10.5, color: 'var(--ink-on-dark-3)', margin: '8px 0 0', fontStyle: 'italic' },
}
